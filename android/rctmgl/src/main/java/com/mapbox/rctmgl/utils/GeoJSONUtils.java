...
public class GeoJSONUtils {
    ...
    public static WritableArray getCoordinates(LineString lineString) {
        ...
        for (Point position : positions) {
            array.pushArray(Arguments.fromArray(position.coordinates()));
        }
    ...
    public static WritableArray getCoordinates(Polygon polygon) {
        ...
        List<List<Point>> positions = polygon.coordinates();
        for (List<Point> curPositions : positions) {
            WritableArray innerArray = Arguments.createArray();

            for (Point position : curPositions) {
                innerArray.pushArray(Arguments.fromArray(position.coordinates()));
            }
