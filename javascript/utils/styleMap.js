...
export const HeatmapLayerStyleProp = PropTypes.shape({
   ...
   */
  heatmapIntensityTransition: TransitionPropType,

  /**
   * The opacity at which the heatmap will be drawn.
   */
   ...
   */
  heatmapOpacityTransition: TransitionPropType,
   ...
   */
  heatmapRadiusTransition: TransitionPropType,

  /**
   * The Heatmap's weight.
   */
