...
//    [styleURLS setObject:[MGLStyle.trafficNightStyleURL absoluteString] forKey:@"TrafficNight"];
    ...
    [interpolationModes setObject:@("linear") forKey:@"Linear"];
    [interpolationModes setObject:@("exponential") forKey:@"Exponential"];
    [interpolationModes setObject:@("categorical") forKey:@"Categorical"];
    [interpolationModes setObject:@("interval") forKey:@"Interval"];
    [interpolationModes setObject:@("identity") forKey:@"Identity"];
